...
<div id="outer">
	...
	<div id="content">
		<h2 align="center">View Packing Entry</h2>
		<br /><br />
		<center>
			<form method="post">
			<table align="center" border="1" cellpadding="0" cellspacing="0" width="90%" style="text-align:center;z-index:-500;">
				...
				<?php
					$i = 1;
					$sel = "select * from pak_entry join product on product.p_id = pak_entry.p_id join sub_product on sub_product.sp_id = pak_entry.sp_id";
					$res = mysql_query($sel);
				...
				?>
					<tr>
						...
						<td><a href="pak_bill.php?bill=<?php echo $row['pe_id'] ?>"><img src="images/icon-more.gif" title="Bill" class="icon" /></a></td>
					</tr>
				<?php
					}
				?>
