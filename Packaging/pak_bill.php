<?php
	...
	if($_SESSION['user'])
	{
		...
		{
			$vbill = $_REQUEST['bill'];
			$sel = "select * from pak_entry join product on product.p_id = pak_entry.p_id join sub_product on sub_product.sp_id = pak_entry.sp_id where pe_id = '$vbill'";
			$res = mysql_query($sel);
...
<div id="outer">
	...
	<div id="content">
		<h2 align="center">Package Bill</h2>
		<br /><br />
		<center>
