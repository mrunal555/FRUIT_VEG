<?php
	...
	if($_SESSION['user'])
	{
		...
		$sel = "select * from pak_reg join country on country.c_id = pak_reg.c_id join state on state.s_id = pak_reg.s_id join city on city.ct_id = pak_reg.ct_id where username = '$vuser'";
		$res = mysql_query($sel);
