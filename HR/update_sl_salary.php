	...
	<div id="content">
		...
		<?php
			...
			if(isset($_REQUEST['btn_update']))
			{
				...
				mysql_query($update);
				header("location:view_sales_salary.php");
		...
		<form method="post">
			<table align="center" height="200px" width="36%">
				<tr>
					<th>Employee ID</th>
					<td><input type="text" name="txt_eid" value="<?php echo $row['emp_id'] ?>" readonly="true" class="input" /></td>
				</tr>
				<tr>
					<th>Employee Name</th>
					<td><input type="text" name="txt_emp" value="<?php echo $row['emp_name'] ?>" readonly="true" class="input" /></td>
				</tr>
				<tr>
					<th>Total Salary</th>
