...
<div id="outer">
	...
	<div id="submenu">
		<a href="purchase_detail.php"><div class="submenu select">Purchase Detail</div></a>
	...
	<div id="content">
		...
		<center>
		<?php
			if(isset($_REQUEST['p_emp_id']))
			{
				$vid = $_REQUEST['p_emp_id'];
				$sel = "select * from purchase_reg where pr_emp_id = '$vid'";
				$res = mysql_query($sel);
		...
		<form method="post">
			<table align="center" height="200px" width="36%">
				<tr>
					<th>Employee ID</th>
					<td><input type="text" name="txt_eid" value="<?php echo $row['pr_emp_id'] ?>" class="input" /></td>
				</tr>
				<tr>
					<th>Employee Name</th>
