...
<div id="outer">
	...
	<div id="content">
		<h2 align="center">View Account Salary</h2>
		<br /><br />
		<center>
		<form method="post">
			<table align="center" border="1" cellpadding="0" cellspacing="0" width="100%" style="text-align:center;">
				...
				<?php
					$i = 1;
					$sel = "select * from salary where emp_id LIKE 'AC%'";
					$res = mysql_query($sel);
				...
				<tr>
					...
					<td><a href="update_ac_salary.php?eid=<?php echo $row['emp_id'] ?>"><img src="images/edit.png" width="30px" height="30px" style="border:0px;" /></a></td>
				<?php
					}
				?>
				</tr>
