...
<div id="outer">
	...
	<div id="submenu">
		...
		<a href="ac_detail.php"><div class="submenu select">Account Detail</div></a>
	...
	<div id="content">
		...
		<center>
		<?php
			if(isset($_REQUEST['a_emp_id']))
			{
				$vid = $_REQUEST['a_emp_id'];
				$sel = "select * from account_reg where ac_emp_id = '$vid'";
				$res = mysql_query($sel);
		...
		<form method="post">
			<table align="center" height="200px" width="36%">
				<tr>
					<th>Employee ID</th>
					<td><input type="text" name="txt_eid" value="<?php echo $row['ac_emp_id'] ?>" class="input" /></td>
				</tr>
				<tr>
					<th>Employee Name</th>
