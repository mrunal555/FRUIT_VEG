...
<div id="outer">
	...
	<div id="content">
		...
		<center>
		<?php
			if(isset($_REQUEST['h_emp_id']))
			{
				$vid = $_REQUEST['h_emp_id'];
				$sel = "select * from hr_reg where hr_emp_id = '$vid'";
				$res = mysql_query($sel);
		...
		<form method="post">
			<table align="center" height="200px" width="36%">
				<tr>
					<th>Employee ID</th>
					<td><input type="text" name="txt_eid" value="<?php echo $row['hr_emp_id'] ?>" class="input" /></td>
				</tr>
				<tr>
					<th>Employee Name</th>
