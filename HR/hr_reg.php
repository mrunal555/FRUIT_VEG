<?php
	...
	if(isset($_REQUEST['btn_submit']))
	{
		...
		$insert = "insert into hr_reg(hr_emp_id,fname,lname,username,password,address,c_id,s_id,ct_id,gender,contact,e_mail,dob) values('$vemp','$vfnm','$vlnm','$vunm','$vpwd','$vadd','$vcountry','$vstate','$vcity','$vgender','$vmob','$vemail','$vdob')";
		mysql_query($insert);
...
<div id="outer">
	...
	<div id="menu">
		...
		<ul>
			...
			<li><a href="hr_reg.php" class="active">Registration</a></li>
		</ul>
	</div>
	...
	<div id="content">
		<h2 align="center">HR Registration</h2>
		<br /><br />
		<center><form method="post">
			<table align="center" height="600px" width="36%" style="border:2px solid #000000;padding-top:10px;border-radius:10px;">
				<tr align="center">
					...
					?>
					<td><input type="text" name="txt_emp" value="HR00<?php echo $a ?>" class="input" readonly="true" /></td>
