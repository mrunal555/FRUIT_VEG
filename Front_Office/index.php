<?php
	...
	if(isset($_REQUEST['btn_login']))
	{
		...
		$sel = "select * from fo_reg where username = '$vunm' and password = '$vpwd'";
		$res = mysql_query($sel);
		
		if(mysql_num_rows($res))
		{
			$_SESSION['user'] = $vunm;
			header("location:fo_home.php");
		}
		else
		{
...
<div id="outer">
	...
	<div id="menu">
		...
		<ul>
			...
			<li><a href="fo_reg.php">Registration</a></li>
		</ul>
	</div>
	...
	<br /><br />
		...
		<center><form method="post">
			<table align="center" height="100px" width="320px">
				<tr>
					<td>Username</td>
