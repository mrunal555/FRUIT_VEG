<?php
	...
	if($_SESSION['user'])
	{
		...
		$sel = "select * from fo_reg join country on country.c_id = fo_reg.c_id join state on state.s_id = fo_reg.s_id join city on city.ct_id = fo_reg.ct_id where username = '$vuser'";
		$res = mysql_query($sel);
		...
		if(isset($_REQUEST['btn_update']))
		{
			...
			$update = "update fo_reg set fname = '$vfnm',lname = '$vlnm',address = '$vadd',c_id = '$vcountry',s_id = '$vstate',ct_id = '$vcity',contact = '$vmob',e_mail = '$vemail',dob = '$vdob' where username = '$vuser'";
			mysql_query($update);
			header("location:fo_profile.php");
		}
?>
...
<div id="outer">
	...
	<div id="menu">
		...
		<ul>
			<li><a href="fo_home.php" class="active">Home</a></li>
			<li><a href="fo_profile.php">View Profile</a></li>
	...
	<div id="content">
		...
		<center><form method="post">
			<table align="center" border="1" width="400px" height="400px" cellpadding="0" cellspacing="0">
				<tr>
					<th>First Name</th>
					<td align="center"><input type="text" name="txt_fnm" value="<?php echo $rows['fname'] ?>" /></td>
				</tr>
				<tr>
					<th>Last Name</th>
					<td align="center"><input type="text" name="txt_lnm" value="<?php echo $rows['lname'] ?>" /></td>
				</tr>
				<tr>
					<th>Address</th>
					<td align="center"><input type="text" name="txt_address" value="<?php echo $rows['address'] ?>" /></td>
				</tr>
				<tr>
					<th>Country</th>
					<td align="center">
				...
				<tr>
					<th>Contact No.</th>
					<td align="center"><input type="text" name="txt_mob" value="<?php echo $rows['contact'] ?>" /></td>
				</tr>
				<tr>
					<th>E-mail</th>
					<td align="center"><input type="text" name="txt_email" value="<?php echo $rows['e_mail'] ?>" /></td>
				</tr>
				<tr>
					<th>Date Of Birth</th>
					<td align="center"><input type="text" name="txt_dob" value="<?php echo $rows['dob'] ?>" /></td>
				</tr>
			</table>
			<table style="margin-top:10px;">
					<tr>
						<td align="center"><input type="submit" name="btn_update" value="Update" /></a></td>
					</tr>
				</table>
		</form></center>
	</div>
