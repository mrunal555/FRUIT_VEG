<?php
	...
	if($_SESSION['user'])
	{
		...
		//Print in text box
		$sel = "select * from sales_reg join salary on salary.emp_id = sales_reg.sl_emp_id where username = '$vuser'";
		$res = mysql_query($sel);
...
<div id="outer">
	...
	<div id="header">
		<div id="headercontent">
			<h1>Fruit & Vegetable Packing ERP</h1>
			<h2></h2>
		</div>
	</div>
		...
		<center>
			...
			?>
				<table align="center" border="0" width="470px" height="180px">
					<tr>
						<th>Employee ID</th>
						<td><input type="text" name="txt_eid" value="<?php echo $row['sl_emp_id'] ?>" class="input" readonly="true" /></td>
					</tr>
					<tr>
						<th>Employee Name</th>
