...
<div id="outer">
	...
	<div id="menu">
		...
		<ul>
			...
			<li><a href="backup_attendance.php">HR</a></li>
	...
	<div id="submenu">
		<a href="profit.php"><div class="submenu1 select">Business Profit</div></a>
		<a href="account_attendance.php"><div class="submenu1">Attendance</div></a>
	</div>
