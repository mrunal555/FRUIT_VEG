...
<div id="outer">
	...
	<div id="menu">
		...
		<ul>
			...
			<li><a href="backup_attendance" class="active">HR</a></li>
	...
	<div id="submenu">
		<a href="backup_attendance.php"><div class="submenu1">Backup Attendance</div></a>
		<a href="hr_attendance.php"><div class="submenu1 select">Attendance</div></a>
	</div>
	<div id="menubottom"></div>

	
	<div id="content">
		<h2 align="center">Account Attendance</h2>
		<br /><br />
		<center>
			<form method="post">
			...
			<table align="center" border="1" cellpadding="0" cellspacing="0" width="100%" style="text-align:center;">
				...
				<?php
					$i = 1;
					$sel = "select * from attendance where emp_id LIKE '%HR%'";
					$res = mysql_query($sel);
