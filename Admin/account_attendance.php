...
<div id="outer">
	...
	<div id="menu">
		...
		<ul>
			...
			<li><a href="profit.php" class="active">Account</a></li>
	...
	<div id="submenu">
		<a href="profit.php"><div class="submenu1">Business Profit</div></a>
		<a href="account_attendance.php"><div class="submenu1 select">Attendance</div></a>
	</div>
	...
	<div id="content">
		...
		<center>
			...
			<table align="center" border="1" cellpadding="0" cellspacing="0" width="100%" style="text-align:center;">
				...
				<?php
					$i = 1;
					$sel = "select * from attendance where emp_id LIKE '%AC%'";
					$res = mysql_query($sel);
