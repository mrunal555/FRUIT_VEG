...
<div id="outer">
	...
	<div id="submenu">
		...
		<a href="hr_detail.php"><div class="submenu select">HR</div></a>
	</div>
	...
	<div id="content">
		...
		<center><form method="post">
			<table align="center" border="1" cellpadding="0" cellspacing="0" width="90%" style="text-align:center;">
				...
				<?php
					$i = 1;
					$sel = "select * from hr_reg join salary on salary.emp_id = hr_reg.hr_emp_id";
					$res = mysql_query($sel);
				...
				?>
					<tr>
						...
						<!--<td style="background-color:#666600;"><a href="view_hr_detail" style="color:#FFFFFF;">View All Detail</a></td>-->
					</tr>
				<?php
					}
