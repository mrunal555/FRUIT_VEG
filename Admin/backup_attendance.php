...
<div id="outer">
	...
	<div id="menu">
		...
		<ul>
			...
			<li><a href="backup_attendance.php" class="active">HR</a></li>
	...
	<div id="submenu">
		<a href="backup_attendance.php"><div class="submenu1 select">Backup Attendance</div></a>
		<a href="hr_attendance.php"><div class="submenu1">Attendance</div></a>
	</div>
