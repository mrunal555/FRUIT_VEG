<?php
	...
	if($_SESSION['user'])
	{
		...
		{
			$vceid = $_REQUEST['ceid'];
			$select = "select * from customer_reg join country on country.c_id = customer_reg.c_id join state on state.s_id = customer_reg.s_id join city on city.ct_id = customer_reg.ct_id where cust_id = '$vceid'";
		...
		if(isset($_REQUEST['btn_update']))
		{
			...
			$update = "update customer_reg set fname = '$vfnm',lname = '$vlnm',address = '$vadd',c_id = '$vcountry',s_id = '$vstate',ct_id = '$vcity',contact = '$vmob',e_mail = '$vemail',dob = '$vdob' where cust_id = '$vceid'";
			mysql_query($update);
