...
<div id="outer">
	...
	<div id="submenu">
		...
		<a href="sales_detail.php"><div class="submenu select">Sales</div></a>
	...
	<div id="content">
		<h2 align="center">Sales Employees Detail</h2>
		<br /><br />
		<center><form method="post">
			<table align="center" border="1" cellpadding="0" cellspacing="0" width="90%" style="text-align:center;">
				...
				<?php
					$i = 1;
					$sel = "select * from sales_reg join salary on salary.emp_id = sales_reg.sl_emp_id";
					$res = mysql_query($sel);
				...
				?>
					<tr>
						<td><?php echo $i++ ?></td>
						<td><?php echo $row['sl_emp_id'] ?></td>
						<td><?php echo $row['username'] ?></td>
						<td><?php echo $row['password'] ?></td>
						<td><?php echo $row['contact'] ?></td>
						<td><?php echo $row['salary'] ?></td>
						
						<!--<td style="background-color:#666600;"><a href="view_sl_detail" style="color:#FFFFFF;">View All Detail</a></td>-->
					</tr>
				<?php
					}
