...
<div id="outer">
	...
	<div id="submenu">
		...
		<a href="account_detail.php"><div class="submenu select">Account</div></a>
	...
	<div id="content">
		<h2 align="center">Account Employees Detail</h2>
		<br /><br />
		<center><form method="post">
			<table align="center" border="1" cellpadding="0" cellspacing="0" width="90%" style="text-align:center;">
				...
				<?php
					$i = 1;
					$sel = "select * from account_reg join salary on salary.emp_id = account_reg.ac_emp_id";
					$res = mysql_query($sel);
				...
				?>
					<tr>
						...
						<!--<td style="background-color:#666600;"><a href="view_ac_detail" style="color:#FFFFFF;">View All Detail</a></td>-->
					</tr>
				<?php
					}
