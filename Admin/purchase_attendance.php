...
<div id="outer">
	...
	<div id="submenu">
		...
		<a href="purchase_attendance.php"><div class="submenu1 select">Attendance</div></a>
	</div>
	<div id="menubottom"></div>

	
	<div id="content">
		<h2 align="center">Purchase Attendance</h2>
		<br /><br />
		<center>
			<form method="post">
			...
			<table align="center" border="1" cellpadding="0" cellspacing="0" width="100%" style="text-align:center;">
				...
				<?php
					$i = 1;
					$sel = "select * from attendance where emp_id LIKE '%PR%'";
					$res = mysql_query($sel);
