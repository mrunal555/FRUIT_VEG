<?php
	...
	if($_SESSION['user'])
	{
		...
		{
			$vpmid = $_REQUEST['pm_id'];
			
			$del = "delete from product where p_id = '$vpmid'";
			mysql_query($del);
			header("location:product_master.php");
		}
			...
			<table align="center" border="1" cellpadding="0" cellspacing="0" width="30%" style="text-align:center;">
				...
				?>
					<tr>
						...
						<td><a href="product_master.php?pm_id=<?php echo $row['p_id'] ?>" onclick="return confirm('Are You Sure Want to Delete')"><img src="images/delete.png" title="Delete" class="icon" /></a></td>
