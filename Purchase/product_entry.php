	...
	if($_SESSION['user'])
	{
		...
		if(isset($_REQUEST['btn_submit']))
		{
			...
			if($_FILES['type']='image/jpg' || $_FILES['type']='image/jpeg' || $_FILES['type']='image/png')
			{
				...
				$insert = "insert into product_entry(saller,p_id,sp_id,image_name,quantity,price,sale_price,total_price,date) values('$vsaller','$vproduct','$vsub','$path','$vqty','$vprice','$vsale_price','$vtotal','$vdate')";
				mysql_query($insert);
...
<div id="outer">
	...
	<div id="menu">
		...
		<ul>
			...
			<li><a href="product_entry.php" class="active">Product Entry</a></li>
		...
		<center>
			<form method="post" enctype="multipart/form-data">
				<table align="center" border="0" width="450px" height="340px">
					<tr align="center">
						<th>Saller Name</th>
						<td><input type="text" name="txt_sale" required="required" class="input" /></td>
					</tr>
					<tr align="center">
						<th>Product</th>
						<td>
