<?php
	...
	if($_SESSION['user'])
	{
		...
		//Print in text box
		$sel = "select * from purchase_reg join salary on salary.emp_id = purchase_reg.pr_emp_id where username = '$vuser'";
		$res = mysql_query($sel);
		...
		<center>
			...
			?>
				<table align="center" border="0" width="470px" height="180px">
					<tr>
						<th>Employee ID</th>
						<td><input type="text" name="txt_eid" value="<?php echo $row['pr_emp_id'] ?>" class="input" readonly="true" /></td>
					</tr>
					<tr>
						<th>Employee Name</th>
