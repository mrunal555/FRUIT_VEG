<?php
	...
	if($_SESSION['user'])
	{
		...
		if(isset($_REQUEST['sp_eid']))
		{
			$vspeid = $_REQUEST['sp_eid'];
			$select = "select * from sub_product join product on product.p_id = sub_product.p_id where sp_id = '$vspeid'";
		...
		if(isset($_REQUEST['btn_update']))
		{
			...
			$update = "update sub_product set p_id = '$vproduct',sub_product = '$vsub' where sp_id = '$vspeid' ";
			mysql_query($update);
...
<div id="outer">
	...
	<div id="content">
		<h2 align="center">Update Sub Product Master</h2>
		<br /><br />
		<center>
		<form method="post">
			<table align="center" border="0" width="370px" height="130px">
				...
				<tr>
					<th>Sub Product</th>
					<td align="center"><input type="text" name="txt_sub" value="<?php echo $rows['sub_product'] ?>" class="input" /></td>
				</tr>
				<tr>
					<td align="center" colspan="2"><input type="submit" name="btn_update" value="Submit" class="btn" /></td>
				</tr>
			</table>
		</form>
		<br /><br />
			...
			<table align="center" border="1" cellpadding="0" cellspacing="0" width="30%" style="text-align:center;">
				...
				?>
					<tr>
						...
						<td><a href="sub_product_master.php<?php echo $row['sp_id'] ?>"><img src="images/delete.png" title="Delete" class="icon" /></a></td>
						<td><a href="sub_product_update.php<?php echo $row['sp_id'] ?>"><img src="images/edit.png" title="Edit" class="icon" /></a></td>
					</tr>
				<?php
					}
				?>
