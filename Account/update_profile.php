<?php
	...
	if($_SESSION['user'])
	{
		...
		$sel = "select * from account_reg join country on country.c_id = account_reg.c_id join state on state.s_id = account_reg.s_id join city on city.ct_id = account_reg.ct_id where username = '$vuser'";
		$res = mysql_query($sel);
		...
		if(isset($_REQUEST['btn_update']))
		{
			...
			$update = "update account_reg set fname = '$vfnm',lname = '$vlnm',address = '$vadd',c_id = '$vcountry',s_id = '$vstate',ct_id = '$vcity',contact = '$vmob',e_mail = '$vemail',dob = '$vdob' where username = '$vuser'";
			mysql_query($update);
			header("location:ac_profile.php");
		}
?>
...
<div id="outer">
	...
	<div id="menu">
		...
		<ul>
			...
			<li><a href="ac_profile.php" class="active">View Profile</a></li>
	...
	<div id="content">
		...
		<center><form method="post">
			<table align="center" width="34%" height="450px" cellpadding="0" cellspacing="0" style="border:2px solid #000000;padding-top:10px;border-radius:10px;padding-bottom:5px;">
				<tr align="center">
					<th>First Name</th>
